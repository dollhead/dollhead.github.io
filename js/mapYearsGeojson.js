...
$.getJSON("../PriceForBuildings.geojson", function (data) {
    L.geoJson(data, {
        style: function(building) {
            ...
            if (price < 800) return { color: "#313695", fillOpacity: 1, opacity: 1, weight: 0.5};
            else if (price < 1000) return { color: "#4575B4", fillOpacity: 1, opacity: 1, weight: 0.5 };
            else if (price < 1250) return { color: "#74ADD1", fillOpacity: 1, opacity: 1, weight: 0.5 };
            else if (price < 1500) return { color: "#ABD9E9", fillOpacity: 1, opacity: 1, weight: 0.5 };
            else if (price < 2000) return { color: "#E0F3F8", fillOpacity: 1, opacity: 1, weight: 0.5 };
            else if (price < 2500) return { color: "#FFFFBF", fillOpacity: 1, opacity: 1, weight: 0.5 };
            else if (price < 3000) return { color: "#FEE090", fillOpacity: 1, opacity: 1, weight: 0.5 };
            else if (price < 4000) return { color: "#FDAE61", fillOpacity: 1, opacity: 1, weight: 0.5 };
            else if (price < 5000) return { color: "#F46D43", fillOpacity: 1, opacity: 1, weight: 0.5 };
            else if (price < 7000) return { color: "#D73027", fillOpacity: 1, opacity: 1, weight: 0.5 };
            else if (price > 7000) return { color: "#A50026", fillOpacity: 1, opacity: 1, weight: 0.5 };
            return { color: "#d3d3d3" }
        }
    }).addTo(map);
})
